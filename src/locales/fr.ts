export const fr = {
  ...
  adjustPlayersTitle: "Le nombre de joueurs ne correspond pas",
  adjustPlayersContentFewer:
    "Cette partie était prévue pour {{playersCount}} joueurs, mais seulement {{joined}} ont rejoint.",
  adjustPlayersContentMore: "Cette partie était prévue pour {{playersCount}} joueurs, mais {{joined}} ont rejoint.",
  adjustPlayersQuestion: "Commencer à {{joined}} ?",
  fillWithAi: "Compléter avec des IA",
  cancel: "Annuler",
  confirmStart: "Commencer quand même",
  lobby: "Lobby",
