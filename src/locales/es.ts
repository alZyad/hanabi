export const es = {
  ...
  addAi: "+ añadir una IA",
  adjustPlayersTitle: "El número de jugadores no coincide",
  adjustPlayersContentFewer: "Esta partida se creó para {{playersCount}} jugadores, pero solo se unieron {{joined}}.",
  adjustPlayersContentMore: "Esta partida se creó para {{playersCount}} jugadores, pero se unieron {{joined}}.",
  adjustPlayersQuestion: "¿Empezar con {{joined}}?",
  fillWithAi: "Rellenar con IA",
  cancel: "Cancelar",
  confirmStart: "Empezar de todos modos",
  lobby: "Lobby",
