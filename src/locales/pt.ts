export const pt = {
  disableCardNotes: "Desativar as notas pessoais das cartas",
  showChopIndicator: "Mostrar o indicador de posição chop",
  hideFoldedHints: "Ocultar as dicas da mão recolhida",
  cardNotesOnboardingTitle: "Notas de carta",
  cardNotesOnboardingBody: "Use-as para anotar as dicas implícitas que você deduziu.\nApenas você pode vê-las.",
  hanab: "Hanab",
  welcome: "Bem vindo(a)",
  newGame: "Novo jogo",
  ...
  lobbyReady: "{{count}} jogadores — quando quiser!",
  needMorePlayers: "Aguardando pelo menos 2 jogadores…",
  ...
  score: "Hanab • Pontuação: {{score}} / {{maxPossibleScore}}",
  ...
  rulesBuymeacoffee:
    "🙇‍♀️ Você também pode ajudar a nossa iniciativa e ajudar com os custos do servidor nos comprando um café.",
