export const pt = {
  ...
  addAi: "+ adicionar AI",
  adjustPlayersTitle: "O número de jogadores não corresponde",
  adjustPlayersContentFewer: "Este jogo foi criado para {{playersCount}} jogadores, mas apenas {{joined}} entraram.",
  adjustPlayersContentMore: "Este jogo foi criado para {{playersCount}} jogadores, mas {{joined}} entraram.",
  adjustPlayersQuestion: "Começar com {{joined}}?",
  fillWithAi: "Preencher com IA",
  cancel: "Cancelar",
  confirmStart: "Começar mesmo assim",
  lobby: "Lobby",
